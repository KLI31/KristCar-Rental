...
const OrderErrorPage = () => {
  return (
    <div>
      <Navbar />
      <div className="flex items-center justify-center min-h-screen md:pt-16">
        <div className="container py-8 px-4 max-w-4xl w-full">
          ...
          <Card className="mb-8">
            ...
            <CardContent className="text-center space-y-4">
              <p className="text-gray-700">
                Por favor, revisa la información ingresada y vuelve a
                intentarlo.
              </p>
              <p className="text-gray-700">
